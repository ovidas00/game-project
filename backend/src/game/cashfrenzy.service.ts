...
@Injectable()
export class CashfrenzyService {
  private readonly baseUrl = 'https://agentserver.cashfrenzy777.com/api';
  private readonly cacheKey = 'cashfrenzy777:token';
  ...
  async login(): Promise<string> {
    ...
    formData.append('username', 'Legend100');
